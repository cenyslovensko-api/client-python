...
2. Install the binary to `../cenyslovensko_bindings/bin`
...
2. `../cenyslovensko_bindings/bin/cenyslovensko_rpc_server` (installed by CMake)
...
| `BIN_OUTPUT_DIR` | `../cenyslovensko_bindings/bin`                     | Where the binary is installed          |
